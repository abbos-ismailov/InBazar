...
async def show_purchases(msg: types.Message):
    ...
    if user_purchases:
        ...
        await msg.answer("Siz mahsulot xarid qilmagansiz")
...
async def remove_korzinka(call: types.CallbackQuery):
    ...
    try:
        ...
        if new_purchase_pr['product_count'] > 0:
            ...
            text += f"Qolgan kiyimlar soni: {new_purchase_pr['product_count']} \n"
            ...
            await call.answer("Bu mahsulotdan boshqa qolmadi")
            await call.message.reply("Bu mahsulotdan boshqa qolmadi")
